...
export function FiltersSidebar({ isOpen, onClose }) {
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mb-4 border-b border-border">
            <button
              ...
              className={`pb-2 px-1 transition-colors text-sm ${
                activeTab === "ambientes"
          ...
          <div className="mb-6 flex gap-2">
            ...
            />
            <Button className="bg-black text-white hover:bg-black/90 h-9 px-4">
              Search
            </Button>
          </div>
          ...
          {/* Color Filters */}
          <div className="mb-6">
            <h3 className="mb-4 text-md">Color</h3>
            <div className="space-y-2">
              {displayedColors.map((color) => (
                <div key={color.name} className="flex items-center gap-2">
                  ...
                  <label
                    htmlFor={color.name}
                    className="flex-1 cursor-pointer text-muted-foreground hover:text-foreground transition-colors text-sm"
                  >
            ...
            {!showAllColors && (
              <button
                ...
                className="mt-3 text-[#d87f4a] hover:underline text-xs"
              >
                Show 14 more
              </button>
            )}
          ...
          {/* Price Filter */}
          <div>
            <h3 className="mb-4 text-md">Filter by price</h3>
            <Slider
              value={priceRange}

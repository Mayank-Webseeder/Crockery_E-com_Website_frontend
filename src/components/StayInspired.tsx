      ...
      <div className="relative z-10 w-full px-8 lg:px-16">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          ...
          <div className="lg:max-w-lg">
            <h2 className="text-white mb-6">Stay Inspired</h2>
          ...
          <div className="flex gap-4 lg:flex-shrink-0">
            <Input 
              type="email"
              placeholder="E-mail"
              className="bg-white border-white w-full lg:w-80 h-12"
            />
            <Button 
              size="lg"
              className="bg-black text-white hover:bg-black/90 px-8 h-12 flex-shrink-0"
            >
              Subscribe
            </Button>
          </div>

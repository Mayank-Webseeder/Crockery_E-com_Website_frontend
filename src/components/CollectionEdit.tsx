      ...
      <div className="w-full px-8 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-white mb-6" style={{ fontFamily: 'Playfair Display, serif', fontWeight: 400, fontSize: '60px' }}>The Artisan Edit</h1>
            <p className="text-white/80 mb-8 leading-relaxed">
              Unwind in style. Discover our handpicked selection of ceramic dinnerware, serveware, and drinkware designed for effortless elegance and timeless appeal.
            </p>
            <div>
              <Button 
                className="bg-black text-white border-2 border-white hover:bg-white hover:text-black transition-colors duration-300"
              >
                Shop Collection
              </Button>
            </div>

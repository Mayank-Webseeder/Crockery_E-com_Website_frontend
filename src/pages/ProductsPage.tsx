...
const categoryImages = [
  {
    ...
    image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxsaXZpbmclMjByb29tJTIwY2hhaXJ8ZW58MXx8fHwxNzYwNTA2NzIzfDA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Serveware Sets",
    image: "https://images.unsplash.com/photo-1616594039964-ae9021a400a0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiZWRyb29tJTIwaW50ZXJpb3J8ZW58MXx8fHwxNzYwMzk4NjA1fDA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Tea & Coffee Sets",
    image: "https://images.unsplash.com/photo-1698280954292-c955f882486f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaW5pbmclMjB0YWJsZSUyMHNldHRpbmd8ZW58MXx8fHwxNzYwNDUxODAzfDA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Fine China",
    image: "https://images.unsplash.com/photo-1520624197313-3fa687a6add5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob21lJTIwZGVjb3IlMjBhY2Nlc3Nvcmllc3xlbnwxfHx8fDE3NjA0NTA5NzJ8MA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Artisan Pottery",
    image: "https://images.unsplash.com/photo-1622433488405-1a28d05f85f7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBsaWdodGluZyUyMGZpeHR1cmVzfGVufDF8fHx8MTc2MDUwNjQ0MXww&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Table Accessories",
    image: "https://images.unsplash.com/photo-1650338031185-1e97add7a389?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvdXRkb29yJTIwcGF0aW8lMjBkaW5pbmd8ZW58MXx8fHwxNzYwNTA2NDQwfDA&ixlib=rb-4.1.0&q=80&w=1080"
  }
];
...
export function ProductsPage() {
  const [viewMode, setViewMode] = useState<"list" | "grid2" | "grid3">("grid3");
    ...
    <div>
            ...
            <div key={category.title} className="group cursor-pointer">
              <div className="aspect-[4/5] overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                  <h3 className="text-white text-center px-4">{category.title}</h3>
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="w-full px-8 lg:px-16 py-16">
        ...
        <div className="flex items-center justify-between mb-12 pb-6 border-b border-border">
          ...
          {/* Right - Filters, View Options and Sorting */}
        ...
        <div className={`grid ${gridClass} gap-8`}>
          {products.map((product) => (
            <div key={product.id} className="relative">
              {/* Badge */}
              {product.badge && (
                <div className="absolute top-4 left-4 bg-white border border-[#d87f4a] text-[#d87f4a] px-3 py-1 text-sm z-10">
                  {product.badge}
                </div>
              )}
              {product.discount && (
                <div className="absolute top-4 left-4 bg-[#d87f4a] text-white px-3 py-1 text-sm z-10">
                  {product.discount}
                </div>
              )}
        ...
        <div className="flex items-center justify-center gap-2 mt-16">
          ...
          <button className="px-4 h-10 border border-border hover:bg-muted transition-colors flex items-center justify-center gap-2">
            Next →
          </button>
        </div>
      </div>
